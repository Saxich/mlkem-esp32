...
void poly_tomsg(uint8_t msg[MLKEM_INDCPA_MSGBYTES], const poly *r);
  ...
  #define poly_basemul(r, a, b) poly_basemul_montgomery(r, a, b)
  #define poly_basemul_acc(r, a, b) poly_basemul_acc_montgomery(r, a, b)
...
#define poly_basemul_acc_montgomery MLKEM_NAMESPACE(poly_basemul_acc_montgomery)
