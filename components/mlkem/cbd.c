/*
 * Centered Binomial Distribution (CBD) sampling — cbd2 and cbd3
 *
 * Licensing: GPL-3.0-or-later (see LICENSE and CREDITS.md)
 *
 * SPEED_CODE variant: based on pq-crystals/kyber reference implementation
 *   https://github.com/pq-crystals/kyber
 *   License: CC0-1.0 OR Apache-2.0
 *
 * STACK_CODE variant: based on pq-code-package/mlkem-c-embedded
 *   https://github.com/pq-code-package/mlkem-c-embedded
 *   License: Apache-2.0 OR CC0-1.0
 *   Adds an `add` accumulation parameter to cbd2/cbd3, allowing the result
 *   to be accumulated directly into the output polynomial without a separate
 *   zeroing pass, reducing stack usage.
 *
...
// The stack variant only adds the `add` accumulation parameter; merging both variants has minimal overhead.
#ifdef SPEED_CODE
